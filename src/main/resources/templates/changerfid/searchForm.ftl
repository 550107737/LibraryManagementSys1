...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="oldRfid" name="oldRfid" class="form-control" type="text"   >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">新rfid：</label>
                                <div class="col-sm-8">
                                    <input id="newRfid" name="newRfid" class="form-control" type="text"   >
                                </div>
                            </div>
                            <div class="form-group">
    ...
    function try1() {
        var oldRfid=$("#oldRfid").val();
        parent.$("#oldRfid").attr("value",oldRfid);
        var newRfid=$("#newRfid").val();
        parent.$("#newRfid").attr("value",newRfid);
