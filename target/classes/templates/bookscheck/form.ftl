            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/booksCheckCtrl/addOrEdit">
                        	<input type="hidden" id="checkId" name="checkId" value="${booksCheckModel.checkId}">
