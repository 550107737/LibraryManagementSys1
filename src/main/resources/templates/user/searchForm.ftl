                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="userClass" name="userClass" class="form-control" type="text"   >
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">是否存在逾期书本：</label>
                                <div class="col-sm-8">
                                    <select id="isOverdue" name="isOverdue" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select id="overdueTotalAmount" name="isOverdue" class="form-control">
                                        <option value=-1 selected="selected"></option>
                                        <option value="0" >否</option>
                                        <option value="1" >是</option>
                                    </select>
