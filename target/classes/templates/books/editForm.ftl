...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/bookCtrl/editBook">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="repayTime" name="repayTime" class="laydate-icon form-control layer-date" value="${bookModel.repayTime}" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <#--<div id="dynamicLocation" class="form-group">-->
                                <#--<label class="col-sm-3 control-label">图书馆中的位置：</label>-->
                                <#--<div class="col-sm-8">-->
                                    <#--<input id="libiaryLocation" name="libiaryLocation" class="form-control" value="${bookModel.booksPosition}">-->
                                <#--</div>-->
                            <#--</div>-->
                            <#--<div class="form-group">-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="bookTime" name="bookTime" class="laydate-icon form-control layer-date" value="${bookModel.bookTime}" readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function () {
        ...
        laydate({
            elem: '#repayTime', //目标元素。由于laydate.js封装了一个轻量级的选择器引擎，因此elem还允许你传入class、tag但必须按照这种方式 '#id .class'
            event: 'focus' //响应事件。如果没有传入event，则按照默认的click
        });
        laydate({
    ...
    function select1() {
        var dynamic1='<div id="dynamicBookcase" class="form-group">\n' +
                ...
                '                                    <select name="bookcaseId" class="form-control">\n' +
                '                                \t\t<#list bookcaseModels as r>\n'+
                '                                            <option value="${r.bookcaseId}" <#if bookModel.bookcaseId == r.bookcaseId>selected="selected"</#if>>\n' +
                '                                                ${r.location}\n' +
                '                                            </option>\n' +
                '                                        </#list>\n' +
                '                                    </select>\n' +
    ...
    function select2() {
        var dynamic2='<div id="dynamicLocation" class="form-group">\n' +
                '                                <label class="col-sm-3 control-label">图书馆中的位置：</label>\n' +
                '                                <div class="col-sm-8">\n' +
                '                                    <input id="libraryLocation" name="libraryLocation" class="form-control" value="${bookModel.booksPosition}">\n' +
                '                                </div>\n' +
                '                            </div>';
