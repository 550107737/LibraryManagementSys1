...
public class BorrowCtrl extends BaseController{
    ...
    public JsonResult editBorrow(BorrowModel borrowModel){
        try {
            ...
            BookboxModel bookboxModel=bookboxService.findByBoxId(borrowModel.getReturnBoxId());
    ...
    public Page<BorrowModel> list(
        ...
        Page<BorrowModel> page = borrowService.findAllByLike(searchText, getPageRequest());
        return page;
    }
    ...
    public String edit(@PathVariable Integer id, ModelMap map) {
        ...
        BookboxModel returnBookboxModel=bookboxService.findByBoxId(borrowModel.getReturnBoxId());
        map.put("returnBookboxModel",returnBookboxModel);
        if(borrowModel.getActualBoxId()!=null){
            BookboxModel actualBookboxModel=bookboxService.findByBoxId(borrowModel.getActualBoxId());
