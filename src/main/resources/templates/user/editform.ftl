                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/userCtrl/addOrEditUser">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="borrowNum" name="borrowNum" class="form-control" value="${user.borrowNum}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="overdueTotalAmount" name="overdueTotalAmount" class="form-control" value="${user.overdueTotalAmount}">
                                </div>
                            </div>
                            <div class="form-group">
