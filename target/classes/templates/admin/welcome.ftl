                    ...
                    <div class="row row-sm text-center">
                        <div class="col-xs-6">
                            <div class="panel padder-v item">
                                <div class="h1 text-info font-thin h1" id="totalBorrow">521</div>
                                <span class="text-muted text-xs">书籍总借阅数量</span>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-info">
                                <div class="h1 text-fff font-thin h1"  id="totalBook">521</div>
                                <span class="text-muted text-xs">总书籍数量</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item bg-primary">
                                <div class="h1 text-fff font-thin h1" id="totalPeople">521</div>
                                <span class="text-muted text-xs">总借阅人数</span>
                                <div class="top text-right w-full">
                                    <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="panel padder-v item">
                                ...
                                <span class="text-muted text-xs">访问人数</span>
                        ...
                        <div class="ibox-content">
                            <ul class="todo-list m-t small-list ui-sortable">
                                <li>
                                    ...
                                    <span class="m-l-xs todo-completed" >乔布斯传</span>
                                </li>
                                <li>
                                    <!-- todo 热门书籍 链接  点进去看书籍详细id="popularBook"-->
                                    <a href="widgets.html#" class="check-link"><i class="fa fa-check-square"></i> </a>
                                    <span class="m-l-xs todo-completed" >乔布斯传</span>
                                </li>
                            </ul>
...
<!-- Flot -->
<script src="${ctx!}/assets/js/plugins/flot/jquery.flot.js"></script>
<script src="${ctx!}/assets/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${ctx!}/assets/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${ctx!}/assets/js/plugins/flot/jquery.flot.pie.js"></script>
<!-- 自定义js -->
<script src="${ctx!}/assets/js/content.js"></script>
